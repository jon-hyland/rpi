...
namespace Rpi.Gpio.IO
{
    ...
    public class GpioManager : IStatsWriter
    {
        ...
        /// Class constructor.
        /// </summary>
        public GpioManager(IErrorHandler errorHandler, Config config)
        {
            //vars
        ...
        public void Initialize()
        {
            try
            {
                ...
                _pins[4] = new Pin(basePin: Pi.Gpio[P1.Pin07], mode: GpioPinDriveMode.Input, bank: BankType.Input1, bit: 2, gpioID: 4, pinID: 7);      // input - read bank 1000, bit 2
